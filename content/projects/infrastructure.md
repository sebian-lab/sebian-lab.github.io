...
### Skills Demonstrated
- Azure VM, VNet, NSG provisioning
- Azure Container Instances (ACI)
- Infrastructure as Code (ARM Templates, Deployment Stacks)
- Azure Kubernetes Service (AKS) with NGINX load balancer
- VMware ESXi 8.0 installation and configuration
- Active Directory Domain Services (AD DS) administration
- DHCP scope configuration and domain client join
- vSwitch networking and virtual machine networking
